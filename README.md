...
* [`src/cljs/com_com/`](src/cljs/com_com/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/com_com/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `com-com` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/com_com/config.cljs) defaults to `true` in
...
```clj
(ns com-com.example
  (:require [com-com.config :as config])
